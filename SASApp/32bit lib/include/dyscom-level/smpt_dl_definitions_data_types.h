...
/*uint16_t smpt_dl_get_sampling_frequency(const Smpt_dl_ads129x * const ads129x);*/

typedef enum
{
    Smpt_Dl_Init_Gain_Ch1_10x = 0,
    Smpt_Dl_Init_Gain_Ch1_20x = 1,
    Smpt_Dl_Init_Gain_Ch1_50x = 2,
    Smpt_Dl_Init_Gain_Ch1_100x = 3,
    Smpt_Dl_Init_Gain_Ch1_150x = 4,
    Smpt_Dl_Init_Gain_Ch1_200x = 5,
    Smpt_Dl_Init_Gain_Ch1_250x = 6,
    Smpt_Dl_Init_Gain_Ch1_300x = 7,
    /* unused yet
    Smpt_Dl_Init_Gain_Ch1_ = 8,
    Smpt_Dl_Init_Gain_Ch1_ = 9,
    Smpt_Dl_Init_Gain_Ch1_ = 10,
    Smpt_Dl_Init_Gain_Ch1_ = 11,
    Smpt_Dl_Init_Gain_Ch1_ = 12,
    Smpt_Dl_Init_Gain_Ch1_ = 13,
    Smpt_Dl_Init_Gain_Ch1_ = 14,
    Smpt_Dl_Init_Gain_Ch1_ = 15
*/
    Smpt_Dl_Init_Gain_Ch1_Last = Smpt_Dl_Init_Gain_Ch1_300x
}
Smpt_Dl_Init_Gain_Ch1;
...
typedef struct /* Smpt_dl_init */
{
    ...
    Smpt_Dl_Init_Gain_Ch1 gain_ch1;  /**< pre-amplifier setting for channel 1,
                                      4 bit only, values 0 - 15, other 4 bits a
                                      re free */
