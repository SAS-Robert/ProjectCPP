...
typedef enum
{
    ...
    Smpt_Channel_Red   = 3, // Old wires
    Smpt_Channel_Blue  = 2, // Old wires
    Smpt_Channel_White = 1, // Ny wires - Known as CHANNEL 2 or channel BLUE
    Smpt_Channel_Black = 0, // Ny wires - Known as CHANNEL 1 or channel RED
