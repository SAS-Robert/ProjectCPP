...
typedef enum
{
    // Old values - Red=0, Blue=1, White=2, Black=3
    Smpt_Channel_Red   = 3, // NEW REHAMOVE Red = 3
    Smpt_Channel_Blue  = 2, // NEW REHAMOVE Blue = 2
    Smpt_Channel_White = 1, // NEW REHAMOVE White = 1
    Smpt_Channel_Black = 0, // NEW REHAMOVE Black = 0
