...
# =================== Window decoration ===================
# the top frame
# title_label = Label(top_frame, text='SAS Interface')
...
rnum = 0
tk.Label(ctr_left, font=("Arial Bold", 30), text="CH.1",  bg=ctrl_left_color,
         fg=ctrl_left_fg).grid(row=rnum, column=1)
