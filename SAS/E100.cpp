...
float E100_coefficients[5] =
{
// Scaled for floating point

    0.9959155490394277, -1.6115524496770632, 0.9959155490394279, 1.6115524496770637, -0.991831098078856// b0, b1, b2, a1, a2
...
{
	E100Type *result = (E100Type *)malloc( sizeof( E100Type ) );	// Allocate memory for the object
	E100_init( result );											// Initialize it
...
{
	E100_executionState executionState;          // The executionState structure holds call data, minimizing stack reads and writes
	...
	executionState.pCoefficients = E100_coefficients;    // Each call to filterBiquad() will advance pState and pCoefficients to the next biquad
	...
	E100_filterBiquad( &executionState );		// Run biquad #0
